...
def validate_name():
    ...
    while True:
        if project_name.isalpha():
            ...
            print(" <ERORR> Project name cannot Contain spaces ")
            project_name = input(" Please Enter your project name : ").strip().lower()
    return project_name


#validate details of the Project
def validate_details():
    ...
    while True:
        if project_details.isalpha():
            ...
            print(" <ERROR> Project details canot contain Digts , just use ',' ")
            project_details = input(
                "Please Enter  project details : ").strip().lower()
    ...
    while True:
        try:
            ...
            try:
                ...
                print(" <ERROR> input date is not valid...")
                break
        except:
            print(" <ERROR> input date is not valid...")
            break
...
def validate_fields(id, line):
    ...
    edited_field = input(
        "Enter the field name to be edited from [ 'name', 'details','target', 'startdate', 'enddate'] :").strip().lower()
